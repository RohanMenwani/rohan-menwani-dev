...
export const themeDisclaimers = {
  light: [
    "Warning: Light mode detected. My eyes are filing a formal complaint.",
    "Switching to light mode... bold choice. Very bold.",
    "Light mode? That's a statement. Rohan approves... reluctantly.",
    "Going light? Your monitor just lost 50 cool points.",
    "Light mode activated. Please wear sunglasses, I won't be held responsible.",
  ],
  dark: [
    "Welcome back to dark mode. This is where the real work happens.",
    "Dark mode on. Now we're talking — just like my terminal.",
    "Ahh, dark mode. The natural habitat of every developer.",
    "Back to dark mode. Your retinas say thank you.",
    "Dark mode restored. Rohan approves this message.",
  ],
};
